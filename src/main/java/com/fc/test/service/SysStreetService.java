...
public class SysStreetService implements BaseService<SysStreet, SysStreetExample> {
     ...
     * @return
     */
    public PageInfo<SysStreet> list(Tablepar tablepar, String searchTxt, String searchText) {
        SysStreetExample testExample = new SysStreetExample();
        testExample.setOrderByClause("id ASC");
        if (searchTxt != null && !"".equals(searchTxt)) {
            testExample.createCriteria().andStreetNameLike("%" + searchTxt + "%");
        }
        if (searchText != null && !"".equals(searchText)) {
            testExample.createCriteria().andStreetNameLike("%" + searchText + "%");
        }
